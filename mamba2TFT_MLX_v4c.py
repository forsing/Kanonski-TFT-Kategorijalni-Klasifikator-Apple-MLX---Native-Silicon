...
def treniraj_v2():
    ...
    X, Y = ucitaj_mlx_podatke(csv_putanja, prozor=50)
    ...
    for epoha in range(1, 101):    # 401
        ...
        if epoha % 50 == 0:
            print(f"Epoha [{epoha}/100] | Kategorijalni Gubitak: {epoha_loss/koraci:.4f}")
...
Epoha [50/100] | Kategorijalni Gubitak: 10.6949
Epoha [100/100] | Kategorijalni Gubitak: 4.1502
Trening završen za: 127.74 sekundi.

==================================================
REZULTAT ZA FAJL /data/loto7_4682_k72_loto_plus_1719.csv (Sledeći red - MLX V4):
[ 3  x 10 y 31 z 39]
==================================================
"""
